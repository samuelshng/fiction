...
const std::unordered_map<std::string, truth_table_generator>& truth_table_lookup()
{
    static const std::unordered_map<std::string, truth_table_generator> lookup = {
        ...
        {"a_and_not_b_single", make_tt_generator(&create_a_and_not_b_single_tt)},
        ...
        {"a_or_not_b_single", make_tt_generator(&create_a_or_not_b_single_tt)},
        {"a_single", make_tt_generator(&create_a_single_tt)},
        ...
        {"and_single", make_tt_generator(&create_and_single_tt)},
        {"and_xor", make_tt_generator(&create_and_xor_tt)},
        {"b_fanout", make_tt_generator(&create_b_fan_out_tt)},
        {"b_single", make_tt_generator(&create_b_single_tt)},
        ...
        {"false_single", make_tt_generator(&create_false_single_tt)},
        ...
        {"or_single", make_tt_generator(&create_or_single_tt)},
        ...
        {"true_single", make_tt_generator(&create_true_single_tt)},
        ...
        {"xor_single", make_tt_generator(&create_xor_single_tt)},
        {"xnor", make_tt_generator(&create_xnor_tt)},
        {"xnor_fanout", make_tt_generator(&create_xnor_fan_out_tt)},
        {"xnor_single", make_tt_generator(&create_xnor_single_tt)}};
